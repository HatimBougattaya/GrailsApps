        ...
        <div id="create-illustration" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.illustration}" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <input  type="hidden" name="id" class="form-control" value="${illustration.id}"/>
                </div>

                <div class="form-group">
                    <label class="control-label">Annonce :</label>
                    <g:select name="illustration.annonce.id" from="${emsi.mbds.Annonce.list()}" optionValue="title"  optionKey="id" />
                </div>

                <div class="form-group">
                    <input class="form-control-file" type='file' id="ilusFile" name="ilusFile"/>
                </div>
